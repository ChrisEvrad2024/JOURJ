...
const Orders = () => {
  ...
  // Ouvrir la boîte de dialogue des détails de commande
  const handleViewOrderDetails = (order) => {
    setSelectedOrder(order);
    setShowOrderDetails(true);
  };

  // Initialiser l'annulation d'une commande
  ...
  // Exécuter l'annulation de la commande
  ...
  return (
    <div className="space-y-8">
            ...
            filteredOrders.map((order) => (
              <Card key={order.id} className="overflow-hidden">
                ...
                <CardContent className="p-4 md:p-6">
                  {/* Éléments de la commande - max 3 visibles */}
                  <div className="space-y-4">
                    ...
                    {/* Indication s'il y a plus d'articles */}
                  ...
                  {/* Résumé et actions de la commande */}
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
      ...
      {/* Boîte de dialogue des détails de commande */}
